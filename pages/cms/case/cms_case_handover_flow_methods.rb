...
class CmsCaseHandoverFlowMethods < CmsBasePage
  ...
  def complete_add_contract_recipients
    ...
    wait_for_element_to_include(cms_handover_add_contract_recipient_details_comps.text_page_heading, "Add contract recipient details", timeout: 5)
  ...
  def complete_upload_contract
    ...
    wait_for_element_to_include(cms_handover_upload_contract_comps.text_uploaded_file_name("handover_doc.txt"), "handover_doc.txt", timeout: 5)
  ...
  def complete_share_contract_and_handover_doc
    ...
    wait_for_element_to_include(cms_handover_share_contract_comps.text_page_heading, "Share handover pack", timeout: 5)
